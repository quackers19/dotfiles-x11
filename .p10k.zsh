# Generated by Powerlevel10k configuration wizard on 2022-05-12 at 20:15 AEST.
...
# flat tails, 2 lines, disconnected, right frame, darkest-ornaments, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=34
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=238
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=34
  # Custom icon.
